...
function add_style(){
    ...
    wp_enqueue_style( 'animation', get_template_directory_uri() . '/css/animations.css', array('my-bootstrap-extension'), '1');
}
...
function add_script(){
    ...
    // wp_enqueue_script( 'viewportchecker', get_template_directory_uri() . '/js/jquery.viewportchecker.js', array(), '1')
   //аякс
